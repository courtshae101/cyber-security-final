...
# Does the state an individual lives in increase their risk of being affected by a breach?
This analysis is trying to determine if there is a correlation between location, whether that be state or region in the US and the number of individuals affected by a breach.  
